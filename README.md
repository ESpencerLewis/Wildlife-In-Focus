...
The prototype worked out the interaction, the real-time visual behavior, and the technical approach that were then developed into a public-facing museum installation. The finished exhibit integrates real-time software with physical exhibit hardware and audiovisual systems. It runs every day as a permanent exhibit, averaging about 500 visitors a day.
...
Getting from the TouchDesigner prototype to that system required substantial work:
